...
public class Main {
    ...
    private static void gameStart(Map<String, String> position) {
        if (nonNull(board)){
    ...
    private static void showGame() {
        ...
        System.out.println("Visualização da partida atual");
    ...
    private static void statusGame() {
        ...
        System.out.printf("O jogo atual se enconta como %s\n", board.getStatus().getLabel());
        if (board.hasErrors()) {
    ...
    private static void finishGame() {
        ...
        if (board.gameIsFinished()) {
            ...
            System.out.println("Seu jogo contem erros, verifique na tabela.");
        } else {
